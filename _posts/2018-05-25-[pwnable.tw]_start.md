...
<center> ![file](/img/pwnable.tw/start/01.png) </center>

32bit고 보호기법은 안 걸려있네요!

<center> ![disassemble](/img/pwnable.tw/start/02.png) </center>
...
><center>! [stack_leak](/img/pwnable.tw/start/03.png) </center>
누가봐도 스택처럼 생긴 `0xffae9020`이 바로 나와주네요!
혹시 모르니 gdb로 맞는지 확인해 봅시닷.
<center> ![gdb_check](/img/pwnable.tw/start/04.png) </center>
